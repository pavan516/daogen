...
class Controller
{
  ...
  public function getPhpSource()
  {
    ...
    $s .= PHP_EOL;
    $s .= '    response()'.PHP_EOL;
    $s .= '      ->setStatusCode( 200 )'.PHP_EOL;
    $s .= '      ->setJsonBody( $data );'.PHP_EOL;
    $s .= PHP_EOL;
    ...
    $s .= '      response()'.PHP_EOL;
    $s .= '        ->errorJson(400,\'\',\'Invalid Content-Type: \'.(request()->getHeader(\'Content-Type\')[0] ?? \'\') );'.PHP_EOL;
    $s .= PHP_EOL;
    $s .= '      return true;'.PHP_EOL;
    $s .= '    }'.PHP_EOL;
    $s .= PHP_EOL;
    ...
    $s .= '      response()'.PHP_EOL;
    $s .= '        ->errorJson(400,\'\',\'Invalid {body}\');'.PHP_EOL;
    $s .= PHP_EOL;
    $s .= '      return true;'.PHP_EOL;
    $s .= '    }'.PHP_EOL;
    $s .= PHP_EOL;
    ...
    $s .= '    if (!$ok) {'.PHP_EOL;
    $s .= '      response()'.PHP_EOL;
    $s .= '        ->errorJson(500,\'\',\'Failed to insert item\');'.PHP_EOL;
    $s .= PHP_EOL;
    ...
    $s .= '    response()'.PHP_EOL;
    $s .= '      ->setStatusCode( 200 )'.PHP_EOL;
    $s .= '      ->setJsonBody( $item->asArray() );'.PHP_EOL;
    $s .= PHP_EOL;
    $s .= '    return true;'.PHP_EOL;
    $s .= '  }'.PHP_EOL;
    $s .= PHP_EOL;
    ...
    $s .= '    if (!$ok) {'.PHP_EOL;
    $s .= '      response()'.PHP_EOL;
    $s .= '        ->errorJson(500,\'\',\'Failed to update item\');'.PHP_EOL;
    $s .= PHP_EOL;
